...
public class LuckyService extends AccessibilityService {
    ...
    private void watchChat(AccessibilityEvent event) {
        ...
        if (mLuckyMoneyReceived && !mLuckyMoneyPicked && (mReceiveNode != null)) {
            mMutex = true;
            Utils.printInfo("如果已经接收到红包并且还没有戳开");
        ...
        switch (eventType) {
            ...
            case AccessibilityEvent.TYPE_WINDOW_CONTENT_CHANGED:
                ...
                if (className.equals("com.tencent.mm.ui.LauncherUI")) {
                    ...
                    currentActivityName = WECHAT_LUCKMONEY_RECEIVE_ACTIVITY;
                } else if (className.equals("com.tencent.mm.plugin.luckymoney.ui.LuckyMoneyDetailUI")) {
                    currentActivityName = WECHAT_LUCKMONEY_DETAIL_ACTIVITY;
                } else if (className.equals("com.tencent.mm.ui.chatting.ChattingUI")) {
                    currentActivityName = WECHAT_LUCKMONEY_CHATTING_ACTIVITY;
                }
                break;
        }
